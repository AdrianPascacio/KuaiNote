...
public class Stable_Content_Generator_For_Test {
    ...
    public void Stable_Tasks_Generator(Context context, int Content_Number, int SubTasks_Number, int task_start, int task_end){
        ...
        for(int i = Content_Number ; i>=0; i--){
            ...
            String _title = i + seed_text_short.substring(task_start,task_end);
