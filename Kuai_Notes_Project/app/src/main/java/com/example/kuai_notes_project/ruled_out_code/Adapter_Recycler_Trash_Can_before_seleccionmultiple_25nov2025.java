...
public class Adapter_Recycler_Trash_Can_before_seleccionmultiple_25nov2025 extends RecyclerView.Adapter<Adapter_Recycler_Trash_Can_before_seleccionmultiple_25nov2025.MyViewHolder> {
    ...
    public Adapter_Recycler_Trash_Can_before_seleccionmultiple_25nov2025(Context context, ArrayList date_id, ArrayList<Boolean> selected_id, ArrayList noteList, ArrayList unselected_id, Recycler_Trash_Can_Interface recyclerTrashCanInterface){
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, @SuppressLint("RecyclerView") int position){
        ...
        if(selected_id.get(position)==true){
            ...
            if(unselected_id.get(position)==true){
                ...
                /// Test:
                //unselected_id.set(position,false);
                ///  Test^
            }
        }
    }
