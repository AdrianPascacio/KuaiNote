...
public class Adapter_Recycler_Check_Lists extends RecyclerView.Adapter<Adapter_Recycler_Check_Lists.MyViewHolder> {
    private Context context;
    private ArrayList date_id;
    private ArrayList<Boolean> selected_id;
    private ArrayList<Note> noteList;

    private final Recycler_Check_Lists_Interface recycler_check_lists_interface;
    ...
    public Adapter_Recycler_Check_Lists(Context context,  Recycler_Check_Lists_Interface recyclerCheckListsInterface){
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(context).inflate(R.layout.recycler_check_lists,parent,false);
        return new MyViewHolder(v, recycler_check_lists_interface);
    }
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, @SuppressLint("RecyclerView") int position){
        ...
        holder.title_id.setText(current_check_main.note);
        Log.d("CheckList","   rv  "+current_check_main.note);
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(@NonNull View itemView, Recycler_Check_Lists_Interface recyclerCheckListsInterface){
            super(itemView);
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (recyclerCheckListsInterface != null){
                        //int pos = getAdapterPosition();
                        int pos = getAbsoluteAdapterPosition();
                        if (pos != RecyclerView.NO_POSITION){
                            recyclerCheckListsInterface.onItemClick(pos,v);
                        }
                    }
                }
            });
            itemView.setOnLongClickListener(new View.OnLongClickListener(){
                public boolean onLongClick(View v) {
                    if (recyclerCheckListsInterface != null){
                        int pos = getAbsoluteAdapterPosition();
                        if (pos != RecyclerView.NO_POSITION){
                            recyclerCheckListsInterface.onItemHold(pos,v);
                            return true;
                        }
                    }
                    return false;
            ...
            itemView.findViewById(R.id.FL_Item_Delete_Ghost).setOnClickListener(new View.OnClickListener(){
                ...
                public void onClick(View v){
                    if (recyclerCheckListsInterface != null){
                        int pos = getAbsoluteAdapterPosition();
                        if (pos != RecyclerView.NO_POSITION){
                            recyclerCheckListsInterface.RemoveItem(pos);
                        }
                    }
                }
            });
            itemView.findViewById(R.id.Fl_Item_Pin_Ghost).setOnClickListener(new View.OnClickListener(){
                ...
                public void onClick(View v){
                    if (recyclerCheckListsInterface != null){
                        int pos = getAbsoluteAdapterPosition();
                        if (pos != RecyclerView.NO_POSITION){
                            recyclerCheckListsInterface.PinItem(pos);
                        }
                    }
                }
            });
            itemView.findViewById(R.id.Fl_Reminder_Ghost).setOnClickListener(new View.OnClickListener(){
                ...
                public void onClick(View v){
                    if (recyclerCheckListsInterface != null){
                        int pos = getAbsoluteAdapterPosition();
                        if (pos != RecyclerView.NO_POSITION){
                            recyclerCheckListsInterface.SetReminder(pos);
                        }
                    }
                }
            });
